...
uintptr_t dwppDirect3DDevice9 = 0xA7030;
uintptr_t dwEntityList = 0x4D5450C;
uintptr_t dwLocalPlayer = 0xD3FC5C;
uintptr_t dwGlowObjectManager = 0x529C3D8;
uintptr_t dwForceAttack = 0x3185555;
