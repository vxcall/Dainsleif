...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x3203948},
            {"dwForceBackward", 0x320399C},
            {"dwForceForward", 0x3203990},
            {"dwForceJump", 0x527D390},
            {"dwForceLeft", 0x32039A8},
            {"dwForceRight", 0x32039B4},
            {"dwEntityList", 0x4DD347C},
            {"dwLocalPlayer", 0xDB75DC},
            {"dwGlowObjectManager", 0x531C058},
            {"dwViewMatrix", 0x4DC4D94},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
