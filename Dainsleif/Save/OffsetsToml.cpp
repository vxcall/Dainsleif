...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x31EFCD4},
            {"dwForceBackward", 0x31EFC8C},
            {"dwForceForward", 0x31EFC98},
            {"dwForceJump", 0x5269570},
            {"dwForceLeft", 0x31EFCB0},
            {"dwForceRight", 0x31EFCA4},
            {"dwEntityList", 0x4DBF75C},
            {"dwLocalPlayer", 0xDA544C},
            {"dwGlowObjectManager", 0x5307C48},
            {"dwViewMatrix", 0x4DB1074},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
