...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x3200F94},
            {"dwForceBackward", 0x3200FE8},
            {"dwForceForward", 0x3200FDC},
            {"dwForceJump", 0x527A97C},
            {"dwForceLeft", 0x3200FF4},
            {"dwForceRight", 0x3201000},
            {"dwEntityList", 0x4DD0A84},
            {"dwLocalPlayer", 0xDB558C},
            {"dwGlowObjectManager", 0x5318E18},
            {"dwViewMatrix", 0x4DC2384},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
