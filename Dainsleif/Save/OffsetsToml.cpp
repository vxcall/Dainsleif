...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x31D3704},
            {"dwForceBackward", 0x31D374C},
            {"dwForceForward", 0x31D3758},
            {"dwForceJump", 0x524CFCC},
            {"dwForceLeft", 0x31D3770},
            {"dwForceRight", 0x31D3764},
            {"dwEntityList", 0x4DA31DC},
            {"dwLocalPlayer", 0xD8A2DC},
            {"dwGlowObjectManager", 0x52EB650},
            {"dwViewMatrix", 0x4D94AF4},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
