...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x3206E9C},
            {"dwForceBackward", 0x3206EE4},
            {"dwForceForward", 0x3206ED8},
            {"dwForceJump", 0x5280924},
            {"dwForceLeft", 0x3206EF0},
            {"dwForceRight", 0x3206EFC},
            {"dwEntityList", 0x4DD69DC},
            {"dwLocalPlayer", 0xDBA5BC},
            {"dwGlowObjectManager", 0x531F608},
            {"dwViewMatrix", 0x4DC82F4},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
