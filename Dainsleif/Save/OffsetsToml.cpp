...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x31D7734},
            {"dwForceBackward", 0x31D777C},
            {"dwForceForward", 0x31D7788},
            {"dwForceJump", 0x5250FFC},
            {"dwForceLeft", 0x31D77A0},
            {"dwForceRight", 0x31D7794},
            {"dwEntityList", 0x4DA720C},
            {"dwLocalPlayer", 0xD8E2CC},
            {"dwGlowObjectManager", 0x52EF6B0},
            {"dwViewMatrix", 0x4D98B24},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
