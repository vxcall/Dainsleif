...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x31D44E4},
            {"dwForceBackward", 0x31D449C},
            {"dwForceForward", 0x31D44A8},
            {"dwForceJump", 0x524CEB4},
            {"dwForceLeft", 0x31D44C0},
            {"dwForceRight", 0x31D44B4},
            {"dwEntityList", 0x4DA2F54},
            {"dwLocalPlayer", 0xD8B2CC},
            {"dwGlowObjectManager", 0x52EB548},
            {"dwViewMatrix", 0x4D94854},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
