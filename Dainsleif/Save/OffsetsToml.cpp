...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x31D59A4},
            {"dwForceBackward", 0x31D595C},
            {"dwForceForward", 0x31D5968},
            {"dwForceJump", 0x524F20C},
            {"dwForceLeft", 0x31D5980},
            {"dwForceRight", 0x31D5974},
            {"dwEntityList", 0x4DA541C},
            {"dwLocalPlayer", 0xD8C2CC},
            {"dwGlowObjectManager", 0x52ED8B0},
            {"dwViewMatrix", 0x4D96D34},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
