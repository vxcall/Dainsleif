...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x32022D0},
            {"dwForceBackward", 0x320230C},
            {"dwForceForward", 0x3202300},
            {"dwForceJump", 0x527BC98},
            {"dwForceLeft", 0x3202318},
            {"dwForceRight", 0x3202324},
            {"dwEntityList", 0x4DD1E1C},
            {"dwLocalPlayer", 0xDB65EC},
            {"dwGlowObjectManager", 0x531A118},
            {"dwViewMatrix", 0x4DC3734},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
