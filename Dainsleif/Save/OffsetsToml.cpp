...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x31F1D14},
            {"dwForceBackward", 0x31F1CA4},
            {"dwForceForward", 0x31F1C98},
            {"dwForceJump", 0x526B5A0},
            {"dwForceLeft", 0x31F1CF0},
            {"dwForceRight", 0x31F1CE4},
            {"dwEntityList", 0x4DC178C},
            {"dwLocalPlayer", 0xDA746C},
            {"dwGlowObjectManager", 0x5309C90},
            {"dwViewMatrix", 0x4DB30A4},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
