...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x320BDE8},
            {"dwForceBackward", 0x320BE30},
            {"dwForceForward", 0x320BE24},
            {"dwForceJump", 0x52858FC},
            {"dwForceLeft", 0x320BE3C},
            {"dwForceRight", 0x320BE48},
            {"dwEntityList", 0x4DDB91C},
            {"dwLocalPlayer", 0xDBF4BC},
            {"dwGlowObjectManager", 0x5324618},
            {"dwViewMatrix", 0x4DCD234},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
