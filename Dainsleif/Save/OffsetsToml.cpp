...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x3203928},
            {"dwForceBackward", 0x320397C},
            {"dwForceForward", 0x3203970},
            {"dwForceJump", 0x527D370},
            {"dwForceLeft", 0x3203988},
            {"dwForceRight", 0x3203994},
            {"dwEntityList", 0x4DD345C},
            {"dwLocalPlayer", 0xDB75DC},
            {"dwGlowObjectManager", 0x531C060},
            {"dwViewMatrix", 0x4DC4D74},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
