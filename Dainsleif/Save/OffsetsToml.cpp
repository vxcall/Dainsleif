...
void OffsetsToml::Initialize(std::string& filename)
{
    const toml::value data {
            ...
            {"dwForceAttack", 0x31D26EC},
            {"dwForceBackward", 0x31D2740},
            {"dwForceForward", 0x31D274C},
            {"dwForceJump", 0x524BF9C},
            {"dwForceLeft", 0x31D2764},
            {"dwForceRight", 0x31D2758},
            {"dwEntityList", 0x4DA21AC},
            {"dwLocalPlayer", 0xD892CC},
            {"dwGlowObjectManager", 0x52EA640},
            {"dwViewMatrix", 0x4D93AC4},
            {"dwClientState_State", 0x108},
            {"dwClientState_MaxPlayer", 0x388},
            {"dwClientState_ViewAngles", 0x4D90},
            {"dwppDirect3DDevice9", 0xA7050},
